...
# the sharper maps at this output size. Re-evaluate if the default output
# size moves to 1024 (where 128 -> 512 is an 8x stretch and 256 -> 512 is
# only 4x, so the sharper map may help there). See TODO.md tier 2.
MAP_SIZE = 128
