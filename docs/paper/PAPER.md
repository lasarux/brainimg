<!-- Canonical source: docs/paper/PAPER.typ. This Markdown is a mirror for GitHub
...
we store these pixels efficiently?* PNG stores exact colours and predicts the
...
4. **Fourteen pluggable decoder backends** spanning eight model families
...
= 0.9`, 1024 max side. The Qwen-Image backend is one of four fully-open
...
side-by-sides are similarly produced by `src/decoder.py` and
